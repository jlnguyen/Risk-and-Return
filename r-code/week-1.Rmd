...
So, if market value (interest rate $r$) is same as coupon rate, we buy bond at *face value* or at par. If $r < c_{rate}$, the bond is selling at a premium; we pay more than the face value, and if interest rates are high $r > c_{rate}$, we buy the bond for less than face value. Note however, that these prices adjust the bond face value according to $r$ and $n$ so that the bond is **fairly priced** according to TVM. There is no profit or loss.
